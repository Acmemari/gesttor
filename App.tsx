...
const Comparator = lazyWithRetry(() => import('./agents/Comparator'));
const CalculadorasDesktop = lazyWithRetry(() => import('./agents/CalculadorasDesktop'));
const CadastrosDesktop = lazyWithRetry(() => import('./agents/CadastrosDesktop'));
const AntonioChat = lazyWithRetry(() => import('./agents/AntonioChat'));
const AntonioAdmin = lazyWithRetry(() => import('./agents/AntonioAdmin'));
const AdminDashboard = lazyWithRetry(() => import('./agents/AdminDashboard'));
const MarketTrends = lazyWithRetry(() => import('./agents/MarketTrends'));
const SavedScenarios = lazyWithRetry(() => import('./agents/SavedScenarios'));
const AIAgentConfigAdmin = lazyWithRetry(() => import('./agents/AIAgentConfigAdmin'));
const FarmManagement = lazyWithRetry(() => import('./agents/FarmManagement'));
const LocaisManagement = lazyWithRetry(() => import('./agents/LocaisManagement'));
...
const AnalystManagement = lazyWithRetry(() => import('./agents/AnalystManagement'));
const ClientDocuments = lazyWithRetry(() => import('./agents/ClientDocuments'));
const InitiativesOverview = lazyWithRetry(() => import('./agents/InitiativesOverview'));
const InitiativesActivities = lazyWithRetry(() => import('./agents/InitiativesActivities'));
const InitiativesKanban = lazyWithRetry(() => import('./agents/InitiativesKanban'));
const FeedbackAgent = lazyWithRetry(() => import('./agents/FeedbackAgent'));
const ProjectStructureReport = lazyWithRetry(() => import('./agents/ProjectStructureReport'));
const ProjetoDesktop = lazyWithRetry(() => import('./agents/ProjetoDesktop'));
const PeopleManagement = lazyWithRetry(() => import('./agents/PeopleManagement'));
const DeliveryManagement = lazyWithRetry(() => import('./agents/DeliveryManagement'));
const ProjectManagement = lazyWithRetry(() => import('./agents/ProjectManagement'));
const CalendarAgent = lazyWithRetry(() => import('./agents/CalendarAgent'));
const SupportTicketsDashboard = lazyWithRetry(() => import('./agents/SupportTicketsDashboard'));
const FeedbackList = lazyWithRetry(() => import('./agents/FeedbackList'));
const HerdEvolutionSimulator = lazyWithRetry(() => import('./agents/HerdEvolutionSimulator'));
const AreaCertificadosDesktop = lazyWithRetry(() => import('./agents/AreaCertificadosDesktop'));
const RotinasFazendaDesktop = lazyWithRetry(() => import('./agents/RotinasFazendaDesktop'));
const GestaoSemanal = lazyWithRetry(() => import('./agents/GestaoSemanal'));
const TranscreverReuniao = lazyWithRetry(() => import('./agents/TranscreverReuniao'));
const AgentUsageDashboard = lazyWithRetry(() => import('./agents/AgentUsageDashboard'));
const OrcamentoWorkspace = lazyWithRetry(() => import('./agents/orcamento/OrcamentoWorkspace'));
const NoticiasPecuaria = lazyWithRetry(() => import('./agents/NoticiasPecuaria'));
const VendoOuEngordo = lazyWithRetry(() => import('./agents/VendoOuEngordo'));
