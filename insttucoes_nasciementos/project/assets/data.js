...
const DB = {
  ...
  lotes: [
    ...
    { id:'lote-2', codigo:'EN-02', nome:'Engorda Confinamento', finalidade:'Engorda', sistema:'Confinamento',       status:'Ativo' },
    { id:'lote-3', codigo:'RP-03', nome:'Matrizes IATF',     finalidade:'Reprodução',  sistema:'Pasto',             status:'Ativo' },
  ],
  animais: [
