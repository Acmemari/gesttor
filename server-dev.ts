...
app.all('/api/areas-suggest-destino', (req, res) => handleApiRoute('./api/areas-suggest-destino.ts', req, res));
...
app.all('/api/mapao', (req, res) => handleApiRoute('./api/mapao.ts', req, res));
