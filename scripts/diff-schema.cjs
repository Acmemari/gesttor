...
const schema = {
  ...
  profiles: ['id','nome','descricao','ativo','sort_order','created_at','updated_at'],
  job_roles: ['id','nome','ativo','sort_order','created_at','updated_at'],
  person_profiles: ['id','pessoa_id','perfil_id','cargo_funcao_id','created_at'],
  person_farms: ['id','pessoa_id','farm_id','primary_farm','created_at'],
  person_permissions: ['id','pessoa_id','farm_id','assume_tarefas_fazenda','pode_alterar_semana_fechada','pode_apagar_semana','created_at','updated_at'],
  assignees: ['id','nome'],
  work_weeks: ['id','numero','modo','aberta','data_inicio','data_fim','farm_id','created_at'],
  activities: ['id','semana_id','titulo','descricao','pessoa_id','data_termino','tag','status','created_at'],
  week_history: ['id','semana_numero','total','concluidas','pendentes','closed_at','semana_id','farm_id'],
  ...
  consulting_firms: ['id','nome','analistas','ativo','created_at','updated_at'],
