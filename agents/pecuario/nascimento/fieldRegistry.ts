...
export const LR_REGISTRY: LrField[] = [
  ...
  { id: 'sexo', label: 'Sexo', type: 'sexo', req: true, def: 'bottom' },
  { id: 'porte', label: 'Porte', type: 'select', req: true, options: PORTES, def: 'bottom' },
  { id: 'colostro', label: 'Colostro?', type: 'select', options: COLOSTRO, def: 'bottom' },
  { id: 'peso', label: 'Peso nasc.', type: 'weight', def: 'bottom' },
  { id: 'pesagem', label: 'Pesagem', type: 'select', options: PESAGENS, def: 'bottom' },
